			    			...
			    			<transition name="branches">
				    			...
				    			<div class="mr-1 p-2 border w-100">
						    		<div class="form-row">
										...
										<div class="form-group col-md-12">
											<label for="inputFirstName">Container Type</label>
											
											<multiselect 
		                              			v-model="singleAssetData.container_type" 
		                              			class="form-control p-0" 
		                              			:class="errors.container.container_type ? 'is-invalid' : 'is-valid'"
		                              			placeholder="Container Type" 
		                                  		:custom-label="nameWithCapitalized" 
		                                  		:options="allContainerTypes" 
		                                  		:required="true" 
		                                  		:allow-empty="false" 
		                                  		@input="setContainerType()" 
		                                  		@close="validateFormInput('container_type')" 
		                              		>
		                                	</multiselect>
											...
											<div 
												class="invalid-feedback" 
												style="display: block;" 
												v-show="errors.container.container_type"
											>
									        	{{ errors.container.container_type }}
									  		</div>
										</div>
									</div>
	...
	export default {
		...
		methods : {
            ...
            setContainerType(){
            	...
            	if (Object.keys(this.singleAssetData.container_type).length > 0) {

            		this.singleAssetData.container_type_id = this.singleAssetData.container_type.id;
			...
			validateFormInput (formInputName) {
				...
				switch(formInputName) {
					...
					case 'container_type' :
						...
						if (! this.singleAssetData.container_type) {
							this.errors.container.container_type = 'Container name is required';
						}
						else if (! Object.keys(this.singleAssetData.container_type).length > 0 || ! this.singleAssetData.container_type_id) {
							this.errors.container.container_type = 'Container name is required';
						}
						else{
							this.submitForm = true;
							this.$delete(this.errors.container, 'container_type');
						}
