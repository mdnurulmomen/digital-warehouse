<template>
	<!-- Modal -->
	<div class="modal fade" id="mail-view-modal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
