			...
			<div class="modal-content">
				...
				>
					...
					<div class="modal-body text-center">
						<h4 class="text-danger">Want to delete '{{ (contentToDelete.user_name || contentToDelete.name || (contentToDelete.hasOwnProperty('e_commerce_fulfillment') ? 'the deal' : contentToDelete.hasOwnProperty('number_installment') ? 'the payment' : contentToDelete.hasOwnProperty('subject') ? 'mail' : 'stock' )) | capitalize }}' ?</h4>
