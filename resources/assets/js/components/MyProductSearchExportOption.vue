<template>
	<div class="col-sm-12">
	  	<div class="row form-group">
	  		<div class="col-md-6 col-sm-6 d-flex align-items-center form-group">
	  			<div class="mr-2">
	  				<span>
			  			{{ 
	  		...
	  		<div class="col-md-6 col-sm-6 was-validated text-center d-flex align-items-center form-group">
