							...
							<transition-group name="fade">
												...
												>	
													...
													>
														...
														<input type="text" 
															...
															:class="!errors.product.variations[index].product_variation_sku ? 'is-valid' : 'is-invalid'" 
															@change="validateFormInput('product_variation_sku')" 
															required="true" 
														>

														<div class="invalid-feedback">
												        	{{ errors.product.variations[index].product_variation_sku }}
												  		</div>
													</div>										
												</div>
								...
								>
									...
									>
										<div 
											class="card"
											v-if="singleProductData.spaces[index] && errors.product.spaces[index]"
										>
											<div class="card-body">
												...
												<div class="form-row ml-5 mr-5">
													<div class="form-group col-md-12 text-center">
														...
														<multiselect 
					                              			v-model="singleProductData.spaces[index].type"
					                                	...
					                                	<div 
						                                	class="invalid-feedback" 
						                                	style="display: block;" 
						                                	v-show="errors.product.spaces[index].product_space_type"
					                                	>
													    	{{ errors.product.spaces[index].product_space_type }}
													    </div>
													</div>
												</div>
												...
												<div 
													class="form-row" 
													v-show="singleProductData.spaces[index].type=='containers'"
												>
													<div class="form-group col-md-12">
					                                	...
					                                	<div 
						                                	class="invalid-feedback" 
						                                	style="display: block;" 
						                                	v-show="errors.product.spaces[index].product_containers"
					                                	>
													    	{{ errors.product.spaces[index].product_containers }}
													    </div>
													</div>
												</div>
												...
												>
													<div class="form-group col-md-6">
					                                	...
					                                	<div 
						                                	class="invalid-feedback" 
						                                	style="display: block;" 
						                                	v-show="errors.product.spaces[index].product_container"
					                                	>
													    	{{ errors.product.spaces[index].product_container }}
													    </div>
													</div>

													<div 
														class="form-group col-md-6" 
														v-if="singleProductData.spaces[index].container"
													>
														<label for="inputFirstName">Select Shelves</label>
														<multiselect 
					                              			v-model="singleProductData.spaces[index].container.shelves"
					                                	...
					                                	<div 
						                                	class="invalid-feedback" 
						                                	style="display: block;" 
						                                	v-show="errors.product.spaces[index].product_shelves"
					                                	>
													    	{{ errors.product.spaces[index].product_shelves }}
													    </div>
													</div>
												</div>

												<div class="form-row" v-show="singleProductData.spaces[index].type=='units'">
													<div class="form-group col-md-4">
													...
													>
														...
														<multiselect 
					                              			v-model="singleProductData.spaces[index].container.shelf"
					                                	...
					                                	<div 
						                                	class="invalid-feedback" 
						                                	style="display: block;" 
						                                	v-show="errors.product.spaces[index].product_shelf"
					                                	>
													    	{{ errors.product.spaces[index].product_shelf }}
													    </div>
													</div>

													<div 
														class="form-group col-md-4" 
														v-if="singleProductData.spaces[index].container && singleProductData.spaces[index].container.shelf"
													>
														<label for="inputFirstName">Select Units</label>
														<multiselect 
					                              			v-model="singleProductData.spaces[index].container.shelf.units"
					                                	...
					                                	<div 
						                                	class="invalid-feedback" 
						                                	style="display: block;" 
						                                	v-show="errors.product.spaces[index].product_units"
					                                	>
													    	{{ errors.product.spaces[index].product_units }}
													    </div>
													</div>
												</div>
							...
							<div class="card-body">
								...
								<div class="tab-content tabs card-block">
													...
													>
														<div class="card">
															<div class="card-body">
																...
																<div class="form-row">
																	<label class="col-sm-6 col-form-label font-weight-bold text-right">Curr Qty :</label>
																	<label class="col-sm-6 col-form-label text-left">
									...
									<div class="tab-pane" id="product-store" role="tabpanel">
										...
										<div 
											class="form-row" 
											v-if="singleProductData.spaces && singleProductData.spaces.length"
										>
											<label class="col-sm-6 col-form-label font-weight-bold text-right">
												Address Detail :
											</label>
											<div class="col-sm-12">
												<div class="form-row">
													...
													<div 
														class="col-md-6 ml-auto" 
														v-for="(productAddress, addressIndex) in singleProductData.spaces" 
...
<script type="text/javascript">
	...
	export default {
		...
		*/
			...
			setProductVariation() {
				if (this.singleProductData.variation_type && Object.keys(this.singleProductData.variation_type).length > 0) {
		...
		*/
			...
			setAvailableShelves(index) {
				...
				if (this.singleProductData.spaces[index].container && Object.keys(this.singleProductData.spaces[index].container).length > 0) {
					this.$delete(this.singleProductData.spaces[index].container, 'shelves');
					this.emptyShelves = this.singleProductData.spaces[index].container.container_shelf_statuses;
				}
			},
			setAvailableUnitShelves(index) {
				// console.log('container if has been triggered');
				if (this.singleProductData.spaces[index].container && Object.keys(this.singleProductData.spaces[index].container).length > 0) {
					this.$delete(this.singleProductData.spaces[index].container, 'shelf');
					this.emptyUnitShelves = this.singleProductData.spaces[index].container.container_shelf_statuses;
				}
			},
			setAvailableUnits(index) {
				// console.log('shelf if has been triggered');
				if (this.singleProductData.spaces[index].container && Object.keys(this.singleProductData.spaces[index].container).length > 0 && Object.keys(this.singleProductData.spaces[index].container.shelf).length > 0) {
					this.$delete(this.singleProductData.spaces[index].container.shelf, 'units');
					this.emptyUnits = this.singleProductData.spaces[index].container.shelf.container_shelf_unit_statuses;
				}
			},
			setProductSpaceType(index) {
				// resetting
				this.$delete(this.singleProductData.spaces[index], 'container');
				this.$delete(this.singleProductData.spaces[index], 'containers');
			...
			validateFormInput (formInputName) {
				...
				switch(formInputName) {
					...
					case 'product_sku' :
						...
						if (this.singleProductData.sku && !this.singleProductData.sku.match(/^[_A-z0-9]*((-|&|\s)*[_A-z0-9])*$/g)) {
					...
					case 'product_price' :
						...
						if (this.productMode==='retail' && (!this.singleProductData.price || this.singleProductData.price < 0)) {
						...
						this.singleProductData.spaces.forEach(
							...
							(productSpace, index) => {
								...
								if (!productSpace.type) {
									this.errors.product.spaces[index].product_space_type = 'Space type is required';
								}
								else if (this.singleProductData.spaces.filter((obj) => obj.type === productSpace.type).length > 1) {

									this.errors.product.spaces[index].product_space_type = 'Same type selected';
								}
								else {
						...
						this.singleProductData.spaces.forEach(
							...
							(productSpace, index) => {
								...
								if (productSpace.type=='containers' && (!productSpace.containers || productSpace.containers.length == 0)) {
									this.errors.product.spaces[index].product_containers = 'Container is required';
								}
								else{
						...
						this.singleProductData.spaces.forEach(
							...
							(productSpace, index) => {
								...
								if ((productSpace.type=='shelves' || productSpace.type=='units') && (!productSpace.container || Object.keys(productSpace.container).length==0)) {
									this.errors.product.spaces[index].product_container = 'Container is required';
								}
								else{
						...
						this.singleProductData.spaces.forEach(
							...
							(productSpace, index) => {
								...
								if (productSpace.type=='shelves' && (!productSpace.container || !productSpace.container.shelves || productSpace.container.shelves.length == 0)) {
									this.errors.product.spaces[index].product_shelves = 'Shelf is required';
								}
								else{
						...
						this.singleProductData.spaces.forEach(
							...
							(productSpace, index) => {
								...
								if (productSpace.type=='units' && (!productSpace.container || !productSpace.container.shelf || Object.keys(productSpace.container.shelf).length==0)) {
									this.errors.product.spaces[index].product_shelf = 'Shelf is required';
								}
								else{
						...
						this.singleProductData.spaces.forEach(
							...
							(productSpace, index) => {
								...
								if (productSpace.type=='units' && (!productSpace.container || !productSpace.container.shelf || !productSpace.container.shelf.units || productSpace.container.shelf.units.length == 0)) {
									this.errors.product.spaces[index].product_units = 'Unit is required';
								}
								else{
