				...
				<div class="nav-list">
					...
					<div class="pcoded-inner-navbar main-menu">
						...
						<ul class="pcoded-item pcoded-left-item">
							...
							<li :class="['my-containers', 'my-container-shelves', 'my-shelf-units'].includes(currentRouteName) ? 'active' : ''">
							...
							<li 
								...
								v-if="userHasPermissionTo('view-warehouse-owner-index') || userHasPermissionTo('view-warehouse-index')"
							>
								<a href="javascript:void(0)" class="waves-effect waves-dark">
									<span class="pcoded-micon">
								...
								<ul class="pcoded-submenu">
									<li 
										:class="currentRouteName=='owners' ? 'active' : ''" 
										v-if="userHasPermissionTo('view-warehouse-owner-index')"
									>
									...
									<li 
										:class="currentRouteName=='warehouses' ? 'active' : ''" 
							...
							<li 
								class="pcoded-hasmenu" 
								:class="['my-merchants','merchants'].includes(currentRouteName) ? 'active pcoded-trigger' : ''"
							>
								<a href="javascript:void(0)" class="waves-effect waves-dark">
									<span class="pcoded-micon">
								...
								<ul class="pcoded-submenu">
									<!-- 
									<li :class="currentRouteName=='my-merchants' ? 'active' : ''">
										<router-link :to="{ name: 'my-merchants' }" class="waves-effect waves-dark">
											<span class="pcoded-mtext">My Merchants</span>
										</router-link>
									</li>
									 -->

									<li 
										:class="currentRouteName=='merchants' ? 'active' : ''" 
										v-if="userHasPermissionTo('view-merchant-index')"
									>
										<router-link :to="{ name: 'merchants' }" class="waves-effect waves-dark">
											<span class="pcoded-mtext">All Merchants</span>
										</router-link>
									</li>
								</ul>
							</li>
							...
							<li 
								class="pcoded-hasmenu" 
								:class="['product-categories','my-warehouse-products','products','product-stocks'].includes(currentRouteName) ? 'active pcoded-trigger' : ''"
							>
								<a href="javascript:void(0)" class="waves-effect waves-dark">
									<span class="pcoded-micon">
