											...
											<div class="col-sm-12 col-lg-12">
									  		...
									  		<!-- 
										  		<table-with-soft-delete-option 
										  			...
										  			@fetchManagerAllProducts="fetchManagerAllProducts" 
													...
													<div class="row d-flex align-items-center">
														...
														<div class="col-sm-8 col-12 text-right form-group">
															<pagination
																...
																:pagination="pagination"
																:offset="5"
																@paginate="query === '' ? fetchManagerAllProducts() : searchData()"
															>
															</pagination>
														</div>
													</div>
	...
	export default {
		...
		methods : {
			...
			fetchManagerAllProducts() {
				...
				axios
					.get('/my-products/' + this.perPage + "?page=" + this.pagination.current_page)
					.then(response => {
			...
			fetchProductAllCategories() {
				...
				if (! this.userHasPermissionTo('view-product-category-index')) {
