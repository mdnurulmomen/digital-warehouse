	...
	export default {
		...
		methods : {
			...
			updateAsset(singleAssetData) {
				...
				axios
					.put('/rent-periods/' + singleAssetData.id + '/' + this.perPage, singleAssetData)
					.then(response => {
						if (response.status == 200) {
			...
			deleteAsset(singleAssetData) {
				...
				axios
					.delete('/rent-periods/' + singleAssetData.id + '/' + this.perPage, singleAssetData)
					.then(response => {
						if (response.status == 200) {
			...
			restoreAsset(singleAssetData) {
				...
				axios
					.patch('/rent-periods/' + singleAssetData.id + '/' + this.perPage, singleAssetData)
					.then(response => {
						if (response.status == 200) {
