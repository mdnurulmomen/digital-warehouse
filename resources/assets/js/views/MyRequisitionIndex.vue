								...
								>
									...
									>
										...
										>
											...
											<div class="card" v-if="requiredProduct.merchant_product && requiredProduct.merchant_product.has_variations">
												<div class="card-body">
													<div 
														class="form-row" 
	...
	export default {
		...
		*/
			...
			setRequiredProduct(index) {
				if (this.singleRequisitionData.products[index].merchant_product && Object.keys(this.singleRequisitionData.products[index].merchant_product).length > 0) {
					this.singleRequisitionData.products[index].id = this.singleRequisitionData.products[index].merchant_product.id;
				}
			},
			setRequisitionAgent() {
