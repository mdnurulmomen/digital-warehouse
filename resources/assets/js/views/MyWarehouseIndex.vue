...
<template>
	<div class="pcoded-content">
		...
		<!-- View Modal -->
		<div class="modal fade" id="warehouse-view-modal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
