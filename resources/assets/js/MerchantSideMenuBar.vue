				...
				<div class="nav-list">
					...
					<div class="pcoded-inner-navbar main-menu">
						...
						<ul class="pcoded-item pcoded-left-item">
							...
							<li 
								class="pcoded-hasmenu" 
								:class="['my-products', 'products', 'product-categories', 'category-products', 'product-merchants', 'product-stocks', 'product-manufacturers', 'variation-types', 'variations'].includes(currentRouteName) ? 'active pcoded-trigger' : ''" 
							>
								<a href="javascript:void(0)" class="waves-effect waves-dark">
									<span class="pcoded-micon">
								...
								<ul class="pcoded-submenu">
									...
									<li 
										:class="['product-categories', 'category-products'].includes(currentRouteName) ? 'active' : ''" 
