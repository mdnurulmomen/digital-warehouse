	...
	<div id="pcoded" class="pcoded">
						...
						{{-- 
 						...
 						--}}
							<li class="user-profile header-notification">
								<div class="dropdown-primary dropdown">
									<div class="dropdown-toggle" data-toggle="dropdown">
										<img src="{{ asset(\Auth::guard('manager')->user()->profilePreview->preview) }}" class="img-radius" alt="User-Profile-Image">
										<span>{{ ucwords(\Auth::guard('manager')->user()->user_name) }}</span>
									...
									{{-- 
 									...
 									--}}
										<li>
		                                    ...
		                                    <form id="manager-logout-form" action="{{ route('manager.logout') }}" method="POST" class="d-none">
		                                        @csrf
		                                    </form>
		...
		--}}
			...
			<div id="app">
				...
				<manager-side-menu-bar></manager-side-menu-bar>
