...
<head>
	<title>Gudam | Owner Template</title>

	<meta charset="utf-8">
	<meta http-equiv="content-type" content="text/html;charset=UTF-8" />
	<meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
	<meta http-equiv="X-UA-Compatible" content="IE=edge" />
	<meta name="description" content="Gudam owner template made using Bootstrap 4 and it has huge amount of ready made feature, UI components, pages which completely fulfills any dashboard needs." />
	<meta name="keywords" content="flat ui, owner, Responsive, Landing, Bootstrap, App, Template, Mobile, iOS, Android, apple, creative app">
	...
	<div id="pcoded" class="pcoded">
						...
						{{-- 
 						...
 						--}}
							<li class="user-profile header-notification">
								<div class="dropdown-primary dropdown">
									<div class="dropdown-toggle" data-toggle="dropdown">
										<img src="{{ asset(\Auth::guard('owner')->user()->profilePreview->preview) }}" class="img-radius" alt="User-Profile-Image">
										<span>{{ ucwords(\Auth::guard('owner')->user()->user_name) }}</span>
									...
									{{-- 
 									...
 									--}}
										<li>
		                                    ...
		                                    <form id="owner-logout-form" action="{{ route('owner.logout') }}" method="POST" class="d-none">
		                                        @csrf
		                                    </form>
		...
		--}}
			...
			<div id="app">
				...
				<owner-side-menu-bar></owner-side-menu-bar>
