...
<head>
	<title>Gudam | Warhouse Template</title>

	<meta charset="utf-8">
	<meta http-equiv="content-type" content="text/html;charset=UTF-8" />
	<meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
	<meta http-equiv="X-UA-Compatible" content="IE=edge" />
	<meta name="description" content="Gudam warhouse template made using Bootstrap 4 and it has huge amount of ready made feature, UI components, pages which completely fulfills any dashboard needs." />
	<meta name="keywords" content="flat ui, warhouse, Responsive, Landing, Bootstrap, App, Template, Mobile, iOS, Android, apple, creative app">
						...
						{{-- 
 						...
 						--}}
							<li class="user-profile header-notification">
								<div class="dropdown-primary dropdown">
									<div class="dropdown-toggle" data-toggle="dropdown">
										<img src="{{ asset(\Auth::guard('warhouse')->user()->previews()->first()->preview) }}" class="img-radius" alt="User-Profile-Image">
										<span>{{ ucwords(\Auth::guard('warhouse')->user()->user_name) }}</span>
									...
									{{-- 
 									...
 									--}}
										<li>
											...
											<a href="{{ route('warhouse.logout') }}"
		                                       onclick="event.preventDefault();
		                                                     document.getElementById('warhouse-logout-form').submit();">
		                                        <i class="feather icon-log-out"></i>
		                                        {{ __('Logout') }}
		                                    </a>

		                                    <form id="warhouse-logout-form" action="{{ route('warhouse.logout') }}" method="POST" class="d-none">
		                                        @csrf
		                                    </form>
