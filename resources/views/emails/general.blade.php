																																			...
																																			<td style="padding:0px" align="center">
																																				<table width="100%" cellspacing="0" cellpadding="0" role="presentation">
																																					<tbody>
																																						<tr>
																																							<td align="center">
																																								<a href="{{ config('app.url') }}" title="{{ ucfirst($appName) }}" target="_blank">
																																									<img src="{{ asset('uploads/application/application_logo.png') }}" alt="{{ ucfirst($appName) }} Logo" height="40" width="150" style="display:block;height:40px;width:150px;text-align:center;padding:30px 20px" class="CToWUd">
																																								</a>
																																							</td>
																																						</tr>
																																					</tbody>
																																														...
																																														<tr>
																																															<td style="padding:0px">
																																																<p style="text-align:center;font-size:14px;line-height:16px;color:#5f7d95;margin:0;padding:0">
																																																	...
																																																	<img alt="Sent with love by {{ ucfirst($appName) }}" height="14" src="https://ci6.googleusercontent.com/proxy/3RsTDe_REyoJReeTQHZk0LceFdxVOeynng-g6UXqEnV40CT39ur8KD2TnWSozamlFpN6Ld7ot5I1KxZ2dH0-E9dTpQD6XebkAxkV9G6I5qqq20beS6YHSBw881A1F7lnnEECyo8zDVZD6PruNU8DdYq1_JZfg-os5Kg=s0-d-e1-ft#https://image.email-freepik.com/lib/fe3111717564047f7c1d74/m/1/585cd126-f1bc-4504-88f1-ec80e64f7622.png" style="display:inline-block;padding:0px 2px;text-align:center;height:14px;width:16px;border:0px" width="16" class="CToWUd"><span style="font-family:Arial,Helvetica,sans-serif"> by {{ ucfirst($appName) }}</span>
																																																</p>
																																															</td>
																																														</tr>
																																													</tbody>
																																														...
																																														<tbody>
																																															<tr>
																																																...
																																																<td>
																																																	...
																																																	<a href="{{ $officialMediaItem->link }}" alt="Follow {{ ucfirst($appName) }} on {{ $officialMediaItem->name }}" style="margin-top:0;margin-bottom:0;margin-left:8px;margin-right:8px;padding:0;display:block" target="_blank">
																																																		<img src="{{ asset($officialMediaItem->logo) }}" alt="Follow {{ ucfirst($appName) }} on {{ ucfirst($officialMediaItem->name) }}" width="34" style="margin:0;padding:0;display:block;width:34px;height:34px" class="CToWUd">
																																																	</a>
