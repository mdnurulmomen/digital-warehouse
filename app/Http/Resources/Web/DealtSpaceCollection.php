        ...
        foreach ($this->collection as $key => $dealtSpace) {
            ...
            if (strpos($dealtSpace->space_type, 'ContainerStatus')) {
                ...
                $newContainer = [
                    ...
                    'selected_rent' => new RentResource($warehouseExpectedContainer->warehouseContainer->rents()->where('rent_period_id', $dealtSpace->deal->rent_period_id)->first()),
                ...
                $newShelf = [
                    ...
                    'container' => [
                        ...
                        'selected_rent' => new RentResource($warehouseExpectedShelf->warehouseContainer->shelf->rents()->where('rent_period_id', $dealtSpace->deal->rent_period_id)->first()),
                ...
                $newUnit = [
                    ...
                    'container' => [
                        ...
                        'selected_rent' => new RentResource($dealtSpace->space->warehouseContainer->shelf->unit->rents()->where('rent_period_id', $dealtSpace->deal->rent_period_id)->first())
